      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 fade-in-up">
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <h2 className="text-5xl font-bold font-serif text-shimmer">Kolhapur Traditions</h2>
            <Sparkles className="w-8 h-8 text-orange-500" />
          </div>
          <p className="text-2xl marathi-text mb-4">कोल्हापुरची संस्कृती आणि परंपरा</p>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Discover the rich cultural heritage of Kolhapur, where ancient traditions blend seamlessly with modern life.
            From world-famous crafts to vibrant festivals, experience the authentic soul of Maharashtra.
          </p>
        </div>
            ...
            return (
              ...
              >
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold mb-2 font-serif">{tradition.title}</h3>
                  <p className="text-lg marathi-text mb-3">{tradition.marathi}</p>
                  <p className="text-muted-foreground text-sm leading-relaxed mb-4">{tradition.description}</p>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 glass-effect">
          <div className="text-center mb-8">
            <h3 className="text-3xl font-bold font-serif text-gradient mb-2">Traditional Festivals</h3>
            <p className="text-xl marathi-text">पारंपरिक सण आणि उत्सव</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {festivals.map((festival, index) => (
              ...
              >
                ...
                <p className="text-lg marathi-text mb-2">{festival.marathi}</p>
        ...
        <div className="text-center mt-16">
          <Button size="lg" className="premium-button text-white font-semibold px-8 py-4 text-lg rounded-full">
